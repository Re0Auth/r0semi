...
// clone would not build for anyone who has not run npm.
//
...
//
// Restoring the placeholder satisfies both. It runs as part of `npm run build`
...
The real build output is written here by \`npm run build\` and is not committed.
